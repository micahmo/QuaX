...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        "about": MessageLookupByLibrary.simpleMessage("Про QuaX"),
        ...
        "all_the_great_software_used_by_fritter":
            MessageLookupByLibrary.simpleMessage(
                "Все чудове програмне забезпечення, яке використовує QuaX"),
        ...
        "help_make_fritter_even_better": MessageLookupByLibrary.simpleMessage(
            "Допоможіть зробити QuaX ще кращим"),
        "help_support_fritters_future": MessageLookupByLibrary.simpleMessage(
            "Допоможіть підтримати майбутнє QuaX"),
        ...
        "please_note_that_the_method_fritter_uses_to_import_subscriptions_is_heavily_rate_limited_by_twitter_so_this_may_fail_if_you_have_a_lot_of_followed_accounts":
            MessageLookupByLibrary.simpleMessage(
                "Будь ласка, зверніть увагу, що метод, який використовує QuaX для імпорту підписок, сильно обмежений Twitter, тому він може не спрацювати, якщо у вас багато акаунтів, на які ви підписані."),
        ...
        "something_just_went_wrong_in_fritter_and_an_error_report_has_been_generated":
            MessageLookupByLibrary.simpleMessage(
                "Щойно у QuaX щось пішло не так, і було створено звіт про помилку. Звіт можна відправити розробникам QuaX, щоб вони допомогли розв\'язати проблему."),
        ...
        "your_report_will_be_sent_to_quacker_glitchtip_project":
            MessageLookupByLibrary.simpleMessage(
                "Ваш звіт буде надіслано до проекту QuaX\'s , а деталі конфіденційності можна знайти за посиланням:")
      };
}
